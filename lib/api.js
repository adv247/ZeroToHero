import { BLOCK_PAGE_ENABLED, CLOUDFLARE_WRITE_DELAY_MS, DEBUG, FAST_MODE, FAST_MODE_CONCURRENCY, LIST_ITEM_SIZE } from "./constants.js";
...
export const synchronizeZeroTrustLists = async (items, { prefix = "CGPS List", type = "DOMAIN" } = {}) => {
  ...
  if (toAdd.length) {
    ...
    // ràng NGAY TỪ ĐẦU thay vì để tự khám phá qua lỗi 400 giữa chừng.
